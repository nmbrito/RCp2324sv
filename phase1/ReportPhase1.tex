...
\chapter{Phase 1}
    ...
    \section{Software install steps}
        First we install, start and configure XAMPP. Using the following \href{https://www.apachefriends.org/download.html}{link} we can choose our prefered method, for this project the portable version was the best choice since no installation was needed.
