...
\chapter{Phase 1}
    ...
    \subsection{WebClient - Python Code}
        ...
        \VerbatimInput{./webclient/httpsocketv3\_output\_20240329.txt}
    ...
    \subsection{Wireshark captures}
        ...
        Capture output
        \VerbatimInput{./wireshark/ws\_capture01\_export.txt} % vpn
        \VerbatimInput{./wireshark/ws\_capture02\_export.txt} % browser
        \VerbatimInput{./wireshark/ws\_capture04\_export.txt} % webclient
