...
The read me file available in the root directory states that we need to run \textit{setup\_xampp} batch file first to populate the registry it's directory. & \raisebox{-\totalheight}{\includegraphics[scale=0.3]{install_xampp08}} \\ % 0.3 scale!
