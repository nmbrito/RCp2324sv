    ...
    \begin{flushleft}
            \begin{center}
                \begin{longtable}{ m{5cm} l }
                    ...
                    text & \includegraphics[scale=0.35 ,valign=c]{} \\ \hline
                    text & \includegraphics[scale=0.34 ,valign=c]{} \\ \hline
                    text & \includegraphics[scale=0.34 ,valign=c]{} \\ \hline
                    text & \includegraphics[scale=0.31 ,valign=c]{} \\ \hline
                    text & \includegraphics[scale=0.35 ,valign=c]{} \\ \hline
                    text & \includegraphics[scale=0.34 ,valign=c]{} \\ \hline
                    text & \includegraphics[scale=0.34 ,valign=c]{} \\ \hline
                    text & \includegraphics[scale=0.34 ,valign=c]{} \\ \hline
                    text & \includegraphics[scale=0.34 ,valign=c]{} \\ \hline
                    text & \includegraphics[scale=0.202,valign=c]{} \\ \hline
